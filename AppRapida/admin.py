...
admin.site.register([Company, UserProfile, Zonify] )
...
class BureauAdmin(admin.ModelAdmin):
    list_display = ('codique', 'province', 'codeclasse', 'nombureau', 'classe', 'ccp', 'sigle', 'nompublic')

admin.site.register(Bureaux, BureauAdmin)

class TarifAdmin(admin.ModelAdmin):
    list_display = ('zone', 'poidsmin', 'poidsmax', 'price')
